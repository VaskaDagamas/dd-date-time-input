...
import { getTitleString, getTodayTime } from '../util/index.js';
    ...
    for (iIndex = 0; iIndex < DateConstants.DATE_ROW_COUNT; iIndex++) {
      ...
      for (jIndex = 0; jIndex < DateConstants.DATE_COL_COUNT; jIndex++) {
        ...
        dateCells.push(
          <td
            key={passed}
            onClick={disabled ? undefined : ops.onSelect.bind(null, current)}
            onMouseEnter={disabled ?
              undefined : ops.onDayHover && ops.onDayHover.bind(null, current) || undefined}
            role="gridcell"
